...
class Y extends MeshPhysicalMaterial {
  // FIX: Explicitly declare the 'defines' property to resolve a TypeScript error where it was not being recognized.
  ...
  constructor(params: any) {
    ...
    this.onBeforeCompile = shader => {
      ...
      // FIX: Replace 'replaceAll' with 'replace' using a global regex for wider JS compatibility.
